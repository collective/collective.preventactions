...
class TestActions(unittest.TestCase):
    ...
    def test_delete_document(self):
        ...
        self.assertRaises(BeforeDeleteException, api.content.delete, self.document)
        self.assertTrue("document" in self.portal.contentIds())
    ...
    def test_move_document(self):
        ...
        self.assertEqual(self.document.absolute_url(), "http://nohost/plone/document")

        self.assertRaises(Exception, api.content.move, self.document, self.folder)

        self.assertRaises(Exception, api.content.rename, self.document, "changed-doc")
        ...
        self.assertRaises(Exception, api.content.rename, self.document, "changed-doc")
        # api.content.move(source=self.document, target=self.folder)
        self.assertEqual(self.document.absolute_url(), "http://nohost/plone/old-doc")
